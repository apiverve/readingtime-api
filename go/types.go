// Package readingtime provides a Go client for the Reading Time Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/readingtime?utm_source=go&utm_medium=readme
package readingtime
...
// Request contains the parameters for the Reading Time Calculator API.
//
// Parameters:
//   - text (required): string - The text to calculate reading time for [maxLength: 500000]
//   - wpm: integer - Words per minute reading speed [min: 50, max: 1000]
type Request struct {
	Text string `json:"text"` // Required
	Wpm int `json:"wpm,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"text": {Type: "string", Required: true, MaxLength: intPtr(500000)},
		"wpm": {Type: "integer", Required: false, Min: float64Ptr(50), Max: float64Ptr(1000)},
	}
...
// ResponseData contains the data returned by the Reading Time Calculator API.
