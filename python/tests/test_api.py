...
class TestReadingtimeAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ReadingtimeAPIClient(self.api_key)

    @patch('apiverve_readingtimecalculator.apiClient.requests.get')
