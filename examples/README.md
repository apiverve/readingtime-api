# Reading Time Calculator API - Examples

This folder contains example code for using the Reading Time Calculator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/readingtime',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/readingtime");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/readingtime](https://docs.apiverve.com/ref/readingtime)
