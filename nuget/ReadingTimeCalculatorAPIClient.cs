...
namespace APIVerve.API.ReadingTimeCalculator
{
    ...
    /// <summary>
    /// Client for the ReadingTimeCalculator API
    /// </summary>
    public class ReadingTimeCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/readingtime";
        ...
        {
            { "text", new ValidationRule { Type = "string", Required = true, MaxLength = 500000 } },
            { "wpm", new ValidationRule { Type = "integer", Required = false, Min = 50, Max = 1000 } }
        };
        ...
        public ReadingTimeCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReadingTimeCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ReadingTimeCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ReadingTimeCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ReadingTimeCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ReadingTimeCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ReadingTimeCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ReadingTimeCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ReadingTimeCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ReadingTimeCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ReadingTimeCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ReadingTimeCalculatorQueryOptions options)
        {
