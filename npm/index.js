...
class readingtimeWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/readingtime');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true,"maxLength":500000},"wpm":{"type":"integer","required":false,"min":50,"max":1000,"default":250}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/readingtime`);
        }
    }
...
module.exports = readingtimeWrapper;
