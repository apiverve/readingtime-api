# Reading Time Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:readingtime-api:1.1.12'
}
```
...
```java
import com.apiverve.readingtime.ReadingTimeCalculatorAPIClient;
import com.apiverve.readingtime.APIResponse;
import com.apiverve.readingtime.APIException;

// Initialize the client
ReadingTimeCalculatorAPIClient client = new ReadingTimeCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/readingtime](https://docs.apiverve.com/ref/readingtime)
...
- **Documentation:** [https://docs.apiverve.com/ref/readingtime](https://docs.apiverve.com/ref/readingtime)
- **Issues:** [GitHub Issues](https://github.com/apiverve/readingtime-api/issues)
